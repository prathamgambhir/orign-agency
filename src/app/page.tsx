...
import { DriftCard, Reveal, MarqueeRow, ScaleIn } from "@/components/motion-primitives";
    ...
    <main className="overflow-hidden bg-[#fbfaf3] text-[#07111f]">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden bg-[#fbfaf3] px-4 pb-16 pt-24 sm:px-6 md:px-8 lg:min-h-[100vh]">
        ...
        <div className="absolute inset-0 max-w-7xl mx-auto hidden lg:block pointer-events-none z-10">
          <div className="absolute top-[20%] left-[4%] -rotate-6 animate-bounce [animation-duration:8s] bg-white border border-[#07111f]/10 px-4 py-2 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-2">
            ...
            <span className="text-[11px] font-black uppercase tracking-wider text-[#07111f]/70">Web Infrastructure</span>
          </div>
          <div className="absolute top-[24%] right-[4%] rotate-3 animate-bounce [animation-duration:11s] bg-white border border-[#07111f]/10 px-4 py-2 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-2">
            ...
            <span className="text-[11px] font-black uppercase tracking-wider text-[#07111f]/70">Interface Design</span>
          </div>
          <div className="absolute bottom-[26%] left-[6%] rotate-6 bg-[#07111f] px-4 py-2 rounded-xl shadow-xl flex items-center gap-2">
            ...
            <span className="text-[11px] font-black uppercase tracking-wider text-white">Cinematic Reels</span>
          </div>
          <div className="absolute bottom-[24%] right-[6%] -rotate-3 bg-white border border-[#07111f]/10 px-4 py-2 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-2">
            ...
            <span className="text-[11px] font-black uppercase tracking-wider text-[#07111f]/70">Social Architecture</span>
          </div>
        </div>
        ...
        <div className="relative z-20 mx-auto w-full max-w-5xl flex flex-col items-center justify-center text-center">
          ...
          <Reveal delay={0.2}>
            <p className="mx-auto mt-8 max-w-md text-xs font-bold leading-relaxed text-[#07111f]/70 px-4 sm:mt-10 sm:text-base sm:max-w-xl md:text-lg">
              Orign architects high-retention podcasts, premium digital interfaces, dynamic shorts, and brand systems that dictate market positioning.
            </p>
          </Reveal>
      ...
      <section id="services" className="px-3 py-12 md:px-8 md:py-20 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <Reveal>
              <div>
                <p className="text-xs font-black uppercase text-[#ff4b3e] md:text-sm">You know what?</p>
            ...
            {services.map((service, index) => {
              ...
              return (
                <Reveal key={service.key} delay={index * 0.05}>
                  <DriftCard
                    className="service-notch min-h-56 md:min-h-64 rounded-2xl md:rounded-3xl border border-[#07111f]/10 bg-white p-5 md:p-7 text-[#073653] shadow-[0_18px_55px_rgba(7,17,31,0.06)] sm:p-6"
                  >
                    <div className="flex h-full flex-col justify-between gap-6 md:gap-8">
                      ...
                      <div>
                        ...
                        <Link href={service.href} className="mt-4 md:mt-6 inline-flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-black uppercase transition hover:text-[#b00046]">
                          Explore
      ...
      {/* Process Section */}
      <section id="process" className="px-3 py-12 text-[#07111f] md:px-8 md:py-20 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="grid gap-4 md:grid-cols-[0.7fr_0.3fr] md:items-end md:gap-8">
              <div>
                <p className="text-xs font-black uppercase text-[#ff8a3d] md:text-sm">Let us show you</p>
              ...
              <Reveal key={step.title} delay={index * 0.08}>
                <div className="grid gap-3 rounded-2xl md:rounded-3xl border border-[#07111f]/10 bg-[#ffc1c7]/55 p-4 md:p-6 shadow-sm transition duration-300 hover:-translate-y-1 md:grid-cols-[0.35fr_0.45fr_0.2fr] md:items-center md:gap-6">
                  <div className="flex items-center gap-3 md:gap-6">
                    ...
                    <h3 className="text-base font-black uppercase leading-none md:text-2xl">{step.title}</h3>
                  </div>
                  <p className="text-xs md:text-sm leading-6 md:leading-7 text-[#07111f]/65">{step.body}</p>
      ...
      <section id="work" className="relative px-3 py-14 bg-[#07111f] text-white md:px-8 md:py-28 rounded-t-[1.5rem] md:rounded-t-[4rem] sm:px-6">
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6 border-b border-white/10 pb-8 md:pb-10">
              <div className="max-w-2xl">
                <p className="text-xs font-black uppercase tracking-widest text-lime-300 mb-2">Selected Showcase</p>
              ...
              <p className="text-xs md:text-sm leading-6 md:leading-7 text-white/60 max-w-xs md:text-right">
                We craft intentional identity shifts through modern web infrastructure, targeted media formats, and digital precision.
              </p>
            </div>
          </Reveal>
              ...
              <ScaleIn key={`${sample.title}-${index}`} delay={index * 0.15}>
                <div className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-white/5 p-2 md:p-3 backdrop-blur-sm border border-white/10 transition-all duration-500 hover:border-lime-300/40 hover:bg-white/10">
                  ...
                  <div className="mt-3 md:mt-4 px-2 flex justify-between items-center">
                    <div>
                      <span className="text-xs font-bold text-lime-300/90 uppercase tracking-wider">{sample.tag}</span>
                    </div>
      ...
      <section id="reviews" className="py-24 bg-[#fbfaf3] overflow-hidden border-t border-[#07111f]/5">
      <div className="mx-auto max-w-6xl px-4 md:px-8 mb-16 sm:px-6">
        <Reveal>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-xl">
              <span className="text-[10px] font-black uppercase tracking-widest text-white bg-[#07111f] px-3 py-1 rounded-md inline-block mb-3">// Verified Ecosystem Trust</span>
              <h2 className="text-4xl font-black uppercase tracking-tighter text-[#07111f] sm:text-5xl md:text-6xl leading-[0.9]">
                Proof in the <span className="inline-block text-transparent [-webkit-text-stroke:1px_#07111f] font-serif lowercase italic tracking-normal normal-case pr-1">metrics.</span>
              </h2>
            </div>
            <p className="max-w-xs text-xs font-bold leading-relaxed text-[#07111f]/60 border-l-2 border-[#b9ff17] pl-4">
              How precise architectural mapping and creative magic unlocked compounding scaling loops for hyper-growth brands.
            </p>
          </div>
        </Reveal>
      </div>
          ...
          {[...reviewsRow1, ...reviewsRow1, ...reviewsRow1].map((review, index) => (
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-[11px] font-black uppercase tracking-wider text-[#07111f] leading-none mb-0.5">{review.author}</h4>
                      <span className="text-[9px] font-bold text-[#07111f]/50 uppercase tracking-widest">{review.role}</span>
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-1">
                    <div className="flex gap-0.5">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="size-2.5 fill-[#07111f] text-[#07111f]" />
                      ))}
                    </div>
                    <span className="text-[8px] font-black uppercase tracking-wider bg-[#561bf4] text-white px-2 py-0.5 rounded-sm">{review.tag}</span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between border-t border-[#07111f]/10 pt-3 mt-2">
                <span className="text-[9px] font-black text-[#07111f]/40 uppercase tracking-widest">Case ID // {review.id}-{index}</span>
        ...
        <MarqueeRow direction="right" speed={28}>
          {[...reviewsRow2, ...reviewsRow2, ...reviewsRow2].map((review, index) => (
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-wider bg-[#b00046] text-white px-2 py-0.5 rounded-sm">{review.tag}</span>
                  </div>
                </div>
                <p className="mt-4 text-xs sm:text-[13px] font-medium leading-relaxed text-[#07111f] whitespace-normal line-clamp-4">
                  &ldquo;{review.text}&rdquo;
              ...
              <div className="flex items-center justify-between border-t border-[#07111f]/10 pt-3 mt-2">
                <span className="text-[9px] font-black text-[#07111f]/40 uppercase tracking-widest">Asset Sync // {review.id}-{index}</span>
                <ArrowUpRight className="size-3.5 text-[#07111f]/60" />
              </div>
            </div>
          ))}
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center">
              <Reveal>
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-lime-300 text-xs font-bold uppercase tracking-widest mb-4 md:mb-6">
                  <Sparkles className="size-3.5 fill-lime-300" /> Partnerships open 2026
                </span>
                ...
                <p className="mt-3 md:mt-4 max-w-lg mx-auto text-xs md:text-base text-white/60 leading-5 md:leading-6">
                  Pick the path tailored to your scale. We execute swiftly, mapping modern tech architecture directly onto raw aesthetic power.
                </p>
              </Reveal>

              <div className="mt-8 md:mt-12 grid gap-4 md:grid-cols-2 md:gap-6 text-left">
                <Reveal delay={0.1}>
                  <AudienceCard icon={<Megaphone className="size-8 md:size-10" />} title="For Companies" button="Let's Collaborate" color="bg-[#24d4c6]" description="We scale internal content setups, build custom apps, and engineer high-impact marketing systems." />
                </Reveal>
                <Reveal delay={0.2}>
                  <AudienceCard icon={<PenTool className="size-8 md:size-10" />} title="For Creators" button="Start Your Project" color="bg-lime-300" description="Turn premium individual formats, episodic podcasts, and unique aesthetics into a sustainable standalone empire." />
                </Reveal>
              </div>
            </div>
          </div>
      ...
      {/* Team Section */}
      <section id="team" className="px-4 py-20 bg-[#fbfaf3] md:px-8 md:py-28 sm:px-6 border-t border-[#07111f]/5">
      <div className="mx-auto max-w-5xl">
        ...
        <Reveal>
          <div className="flex flex-col items-center text-center mb-12 md:mb-20">
            ...
            <h2 className="text-4xl font-black uppercase tracking-tighter text-[#07111f] sm:text-5xl md:text-6xl leading-[0.9]">
              The Minds Behind <br />
              <span className="inline-block text-transparent [-webkit-text-stroke:1px_#07111f] font-serif lowercase italic tracking-normal normal-case pr-1">the magic.</span>
            </h2>
            <p className="mx-auto mt-4 max-w-md text-xs font-bold leading-relaxed text-[#07111f]/60 px-4">
              A precise architecture of tactical thinkers, design pureists, and content engineers collaborating to break retention ceilings.
            </p>
          </div>
        </Reveal>
            ...
            <Reveal key={member.name} delay={index * 0.1}>
              <DriftCard className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border-2 border-[#07111f] bg-white p-4 shadow-[4px_4px_0px_#07111f] transition-all duration-300 hover:shadow-[6px_6px_0px_#07111f] hover:-translate-y-1">
                ...
                <div>
                  ...
                  <div className={`relative aspect-square w-full overflow-hidden rounded-xl border border-[#07111f]/10`}>
      ...
      <section className="px-3 py-12 md:px-8 md:py-20 sm:px-6">
        <div className="mx-auto grid max-w-6xl gap-6 md:gap-10 md:grid-cols-[0.36fr_0.64fr]">
          <Reveal>
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight text-[#073653] md:text-4xl">Common</h2>
              <p className="font-serif text-2xl md:text-4xl italic text-black/45">Questions</p>
              <p className="mt-3 md:mt-4 max-w-xs text-xs md:text-base leading-5 md:leading-6 text-black/60">Everything you need to know about how we work.</p>
              <ButtonLink href="/contact" variant="dark" className="mt-4 md:mt-6 w-full md:w-auto">
                Contact us
              </ButtonLink>
            </div>
          </Reveal>
          <div className="space-y-3 md:space-y-4">
            {[
              ["What is your typical timeline?", "Most focused projects take two to six weeks depending on the scope, approvals, and production needs."],
              ["Do you offer development?", "Yes. We design and develop responsive websites in Next.js with animation, forms, and launch support."],
              ["How do we handle revisions?", "Each project includes structured review rounds so feedback stays clear and momentum stays high."],
              ["Can you manage ongoing social media?", "Yes. We can plan, create, publish, and review monthly content cycles for your brand."],
              ...
              <Reveal key={question} delay={index * 0.06}>
                <details className="group rounded-lg md:rounded-2xl border border-black/10 bg-white p-3 md:p-5 transition-all duration-300 hover:-translate-y-0.5 open:bg-[#ff3a2d] open:text-white">
                  ...
                  <p className="mt-3 md:mt-4 max-w-2xl text-xs md:text-base leading-5 md:leading-7 opacity-80">{answer}</p>
                </details>
              </Reveal>
            ))}
          </div>
          ...
          <Reveal>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col justify-between gap-6 md:flex-row md:items-center">
                <div className="max-w-2xl">
                  <p className="text-xs font-black uppercase tracking-widest text-lime-300 mb-1 md:mb-2">Next Phase Strategy</p>
                  <h2 className="text-lg font-black uppercase leading-[1.1] sm:text-xl md:text-4xl tracking-tight">
                    Ready to boost your brand&apos;s strategic impact and achieve significant growth?
                  </h2>
                </div>
          ...
          <div className="grid gap-6 md:gap-8 py-8 md:py-12 sm:grid-cols-2 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
            <div>
              ...
              <p className="mt-3 md:mt-4 max-w-sm text-xs md:text-sm leading-5 md:leading-6 text-[#073653]/70">
                Follow us for production notes, launch ideas, design systems, and creative strategy.
              </p>
              <a href="mailto:hello@orign.studio" className="mt-3 md:mt-4 block text-xs md:text-sm font-bold text-[#073653] hover:underline">
                hello@orign.studio
              </a>
            </div>
            <FooterLinks title="Pages" links={["Home", "Services", "Work", "Contact"]} />
            <FooterLinks title="Services" links={services.slice(0, 4).map((s) => s.shortTitle)} />
            <FooterLinks title="Social" links={["Instagram", "YouTube", "LinkedIn", "Behance"]} />
          </div>
...
function FloatingTile({ label, className, color }: { label: string; className: string; color: string }) {
  return (
    <div className={`absolute hidden rounded-2xl bg-gradient-to-br ${color} p-5 text-sm font-black uppercase shadow-2xl opacity-70 blur-[0.2px] md:block ${className}`}>
      {label}
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col justify-between rounded-xl md:rounded-2xl bg-white/5 border border-white/10 p-4 md:p-6 backdrop-blur-sm">
      <div>
        ...
        <h3 className="mt-3 md:mt-4 text-base md:text-lg font-black text-white uppercase tracking-tight">{title}</h3>
        <p className="mt-1 md:mt-2 text-xs text-white/60 leading-5">
          {description}
        </p>
      </div>
      <Link href="/contact" className={`mt-4 md:mt-6 inline-flex w-full justify-center items-center rounded-lg md:rounded-xl ${color} py-2 md:py-3 text-xs font-black text-[#07111f] shadow-md transition transform active:scale-[0.98] hover:opacity-90`}>
        {button}
      </Link>
    </div>
  );
...
function FooterLinks({ title, links }: { title: string; links: string[] }) {
  return (
    <div>
      <h3 className="text-xs md:text-sm font-black uppercase tracking-wider text-[#073653]">{title}</h3>
      <div className="mt-2 md:mt-4 grid gap-1 md:gap-2 text-xs md:text-sm text-[#073653]/70">
        {links.map((link) => (
          <a key={link} href={link === "Contact" ? "/contact" : "#"} className="transition hover:text-[#b00046]">
            {link}
          </a>
        ))}
      </div>
